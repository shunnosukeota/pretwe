<div x-data="inputFormHandler()" class="my-2">
    ...
    <template x-if="fields.length < 4">
        <button type="button" @click="addField()" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text- font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 pt-1" viewBox="0 0 20 20" fill="currentColor">
